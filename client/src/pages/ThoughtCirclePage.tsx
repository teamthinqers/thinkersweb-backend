          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-4">
                <div className="p-4 rounded-2xl shadow-xl" style={{ backgroundColor: '#F5D68A' }}>
          ...
          {!isLoading && circles.length === 0 && (
            <Card className="border-amber-200 bg-gradient-to-br from-white to-amber-50">
              <CardContent className="py-12 text-center">
                <Target className="h-16 w-16 mx-auto mb-4" style={{ color: '#F5D68A' }} />
                ...
                >
                  <CardHeader>
                    <CardTitle className="flex items-center gap-2 text-amber-900">
                      <Target className="h-5 w-5" style={{ color: '#F5D68A' }} />
                      {circle.name}
                    </CardTitle>
                  </CardHeader>
                  <CardContent>
