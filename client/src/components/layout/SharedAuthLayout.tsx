          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/notifications">
              <Button
                variant="ghost"
                size="sm"
                className="relative p-2 hover:bg-red-50 border border-red-300 rounded-lg transition-all duration-300 shadow-sm hover:shadow-md"
                title="Notifications"
              >
                <Bell className="h-5 w-5 text-red-600 fill-red-600" />
