...
export default function BadgeDisplay({ badges }: BadgeDisplayProps) {
  ...
  return (
    <Card className="flex items-center gap-1 px-4 py-3 bg-gradient-to-br from-amber-50/80 via-orange-50/80 to-amber-100/80 border-2 border-amber-200/60 shadow-lg backdrop-blur-sm w-full">
      ...
      <div className="flex items-center justify-around flex-1 gap-6">
        {badges.map((badge) => (
