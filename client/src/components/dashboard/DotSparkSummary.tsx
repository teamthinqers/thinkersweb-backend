      ...
      <Card className="w-full mb-8 bg-gradient-to-br from-amber-50 to-white dark:from-amber-950/30 dark:to-gray-950 border border-amber-100 dark:border-amber-900/50 animate-pulse overflow-hidden">
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center gap-2">
            <img src="/dotspark-logo-icon.png" alt="DotSpark" className="h-5 w-5 object-contain rounded" />
            <span>DotSpark</span>
          </CardTitle>
      ...
      <Card className="w-full mb-8 border-red-200 dark:border-red-900/50 bg-red-50 dark:bg-red-950/20">
        <CardHeader className="pb-3">
          <CardTitle className="flex items-center gap-2 text-red-700 dark:text-red-400">
            <img src="/dotspark-logo-icon.png" alt="DotSpark" className="h-5 w-5 object-contain rounded opacity-60" />
            <span>DotSpark</span>
          </CardTitle>
        ...
        <CardContent>
          <p className="text-sm text-red-600 dark:text-red-400 mb-4">
            There was an error connecting to your DotSpark. This could be due to network issues.
          </p>
  ...
  return (
    <Card className="w-full mb-8 bg-gradient-to-br from-amber-50 to-white dark:from-amber-950/30 dark:to-gray-950 border border-amber-100 dark:border-amber-900/50 overflow-hidden">
      <CardHeader className="pb-3">
        ...
        <CardDescription>Your personalized DotSpark</CardDescription>
      </CardHeader>
